...
class Board:
    ...
    def draw_board(self):
        ...
        self._draw_peices()
        pygame.draw.rect(WIN, GRAY, (0, HEIGHT, WIDTH, SCORE_BOARD))
        pygame.draw.rect(WIN, (200, 200, 200), (0+5, HEIGHT+5, WIDTH-10, SCORE_BOARD-10))
